...
import { Users, Globe, Briefcase, AlertTriangle, Wifi, WifiOff, Search, Loader2 } from "lucide-react";
...
const Index = () => {
  ...
  async function handleTrainerSearch(e: React.FormEvent) {
    ...
    try {
      ...
      // 2. Find active assignment with trainer info
      ...
      const trainer = assignment?.trainer as { full_name: string | null; email: string | null; is_active: boolean } | null;
